...
# ========================================
    ...
    ax.plot(t_r, y_r, color="red", linewidth=1.5,
        label="real_like (raw)")     # ← 수정
    ax.plot(t_c, y_c, color="orange", linestyle="--",
        linewidth=1.5, label="real_like (cleaned)")  # 색도 같이 분리하면 더 보기 좋음
